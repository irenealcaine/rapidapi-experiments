  ...
  return (
    <div className="random-drink-meal">
      ...
      {randomDrink.map((drink) => (
        <div
          className={`drink-item ${darkMode ? "dark" : ""}`}
          key={drink.idDrink}
        >
          ...
          <div className="drink-content">
            ...
            <h3 className="drink-ingredients-title">Ingedients</h3>
            <ul className="drink-ingredients">{renderIngredientList(drink)}</ul>
            <h3 className="drink-ingredients-title">Instructions</h3>
      ...
      {randomMeal.map((meal) => (
        <div
          className={`meal-item ${darkMode ? "dark" : ""}`}
          key={meal.idMeal}
        >
          ...
          <div className="meal-content">
            ...
            <h3 className="drink-ingredients-title">Ingedients</h3>
            <ul className="meal-ingredients">{renderIngredientList(meal)}</ul>
            <h3 className="drink-ingredients-title">Instructions</h3>
